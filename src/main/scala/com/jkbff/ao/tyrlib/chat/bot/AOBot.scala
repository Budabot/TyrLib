...
import com.jkbff.ao.tyrlib.chat._
...
class AOBot(chatPacketHandler: ChatPacketHandler, queue: PacketQueue, username: String, password: String, val character:String, serverAddress: String, portNumber: Int) extends Thread {
